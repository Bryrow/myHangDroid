...
public class GameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupUI(findViewById(R.id.single_game_parent));
...
//            Toast.makeText(this, "You're so Smart!", Toast.LENGTH_SHORT).show();
    ...
    private void setWordFive() {
        String words = "which would there could their about never other after think might being again great where these young shall house every while quite those place found going under heard thing heart right three night round woman began hands world asked cried since words voice whole least years among stood speak leave taken often light money whose child small alone given short large times happy ought known table ready means spoke along above doubt black sense white close state point doing truth water bring added power usual death women hours horse sight wrong tears order early worse quiet chair sorry stand lived";
        String[] wordsArray = words.split(" ");
        Log.d("MYLOG", "Number of Words: " + wordsArray.length);
    ...
    private void setWordSix() {
        String words = "aboard absorb afghan assign cement chorus cleave cornea crunch debris delved drawer duress easily embryo exotic eyelet facade fedora fronds genius giggle gossip helmet heroic kidney loath mallet mortar murmur nephew parody peruse ponder racial ransom rascal realty reason reckon relish rugged scythe sequel shovel simmer sourly stench talons tiring tissue virtue weasel widget wizard wombat";
        String[] wordsArray = words.split(" ");
        Log.d("MYLOG", "Number of Words: " + wordsArray.length);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.action_new:
                AlertDialog.Builder myAlert = new AlertDialog.Builder(GameActivity.this);
                ...
                myAlert.setItems(GAMETYPE, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            case 0:
                                MainActivity.newGame(GameActivity.this);
                                finish();
                                break;
                            case 1:
                                MainActivity.multiPlayerIntent(GameActivity.this);
                                finish();
                                break;
                            case 2:
                                MainActivity.textPlayerGame(GameActivity.this);
                                finish();
                                break;
                            default:
                                break;
            ...
            case R.id.action_scores:
                MainActivity.scores(GameActivity.this);
                finish();
