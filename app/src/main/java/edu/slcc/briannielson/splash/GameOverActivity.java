...
public class GameOverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupUI(findViewById(R.id.game_over_parent));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.action_new:
                AlertDialog.Builder myAlert = new AlertDialog.Builder(GameOverActivity.this);
                ...
                myAlert.setItems(GAMETYPE, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            case 0:
                                MainActivity.newGame(GameOverActivity.this);
                                finish();
                                break;
                            case 1:
                                MainActivity.multiPlayerIntent(GameOverActivity.this);
                                finish();
                                break;
                            case 2:
                                MainActivity.textPlayerGame(GameOverActivity.this);
                                finish();
                                break;
                            default:
                                break;
        ...
        if(!(view instanceof EditText)) {
            ...
            view.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    hideSoftKeyboard(GameOverActivity.this);
                    return false;
                }
